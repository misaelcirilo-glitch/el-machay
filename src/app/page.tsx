        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-[#0f0f1a]">
            <div className="text-center space-y-6 max-w-sm">
                ...
                <p className="text-[10px] text-slate-600 pt-2">
                    Registrate y recibe <span className="text-amber-400 font-bold">50 puntos</span> de bienvenida
                </p>

                <p className="text-[9px] text-slate-700 pt-4">
                    Eres restaurante? <a href="/myvipers" className="text-emerald-500 hover:text-emerald-400">Unete a MyVipers</a>
                </p>
            </div>
        </div>
    );
